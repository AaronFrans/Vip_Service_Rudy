...
{
    public class ConcertPromotor : IKlant
    {
        ...
        {
            return obj is ConcertPromotor promotor &&
                   EqualityComparer<Address>.Default.Equals(Address, promotor.Address) &&
                   Name == promotor.Name &&
                   BtwNumber == promotor.BtwNumber &&
                   EqualityComparer<Dictionary<int, int>>.Default.Equals(NrOfReservations, promotor.NrOfReservations);
        }
        ...
        public ConcertPromotor(Address address, string name, string btwNumber, Dictionary<int, int> nrOfReservations, List<ClientDiscount> staffelDiscount)
        {
            Address = address;
            Name = name;
            BtwNumber = btwNumber;
