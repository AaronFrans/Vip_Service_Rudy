...
{
    public class Organisatie : IKlant
    {
        ...
        {
            return obj is Organisatie organisatie &&
                   EqualityComparer<Address>.Default.Equals(Address, organisatie.Address) &&
                   Name == organisatie.Name &&
                   BtwNumber == organisatie.BtwNumber &&
                   EqualityComparer<Dictionary<int, int>>.Default.Equals(NrOfReservations, organisatie.NrOfReservations);
        }
        ...
        public Organisatie(Address address, string name, string btwNumber, Dictionary<int, int> nrOfReservations, List<ClientDiscount> staffelDiscount)
        {
            Address = address;
            Name = name;
            BtwNumber = btwNumber;
